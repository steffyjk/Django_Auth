"""
Django settings for g_oauth project.
...
SECRET_KEY = 'django-insecure-%q))=ba3-vgb7#11k5_)po^-lkx35o+9oaqhd2lfqkf+*@wz(x'
...
WSGI_APPLICATION = 'g_oauth.wsgi.application'
